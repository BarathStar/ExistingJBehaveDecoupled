...
Scenario: Initial Itinerary - Initial booking  Round Trip,  Direct - 1 stop No Plane Change outbound, Connecting - 1 stop Plane Change inbound,  4 Seniors, Business Select
