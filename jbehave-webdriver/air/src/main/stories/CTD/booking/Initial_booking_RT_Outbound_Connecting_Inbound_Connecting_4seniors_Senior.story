...
Scenario: Initial Itinerary - Initial booking  Round Trip,  Connecting - 1 stop Plane Change outbound, Connecting - 1 stop Plane Change inbound,  4 Seniors with Senior Fare
