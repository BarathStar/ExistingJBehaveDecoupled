Apply for Chase Credit on purchase page while CyberArk is down
...
Scenario: Creating a flight booking with Chase as FOP  on purchase page while CyberArk is unavialable for encryption
