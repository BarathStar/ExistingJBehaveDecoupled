Verify Oops message when checkin the second booking from CS2 with extra seat as an adult
...
As an user
In order to checkin
I want to see an Oops message when I try to checkin the second booking from CS2 with extra seat
So that

Scenario: Verify Oops message when checkin the second booking from CS2 with extra seat condition
