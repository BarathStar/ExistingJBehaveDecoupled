Attempt a group checkin for ineligible and eligible passengers
...
Scenario: View error message when trying to check-in a Group Reservation with some ineligible passengers
Given I am:
    |Field|Value|
...
And I have my reservation with all its passengers eligible to checkin online except for 1
