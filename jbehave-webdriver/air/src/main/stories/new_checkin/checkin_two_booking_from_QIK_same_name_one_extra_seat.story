Verify Oops message when checkin the second booking from QIK with extra seat as an adult
...
As an user
In order to checkin
I want to see an Oops message when I try to chekin the second booking from QIK with extra seat
So that

Scenario: Verify Oops message when checkin the second booking from QIK with extra seat condition
...
And I have this flight booked from QIK with crossReference
