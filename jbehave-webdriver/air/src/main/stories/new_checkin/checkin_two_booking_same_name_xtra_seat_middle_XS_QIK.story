Verify Oops message when checkin the second booking with extra seat and cross reference, the first booking from QIK as an adult
...
As an user
In order to checkin
I want to see an Oops message when I try to chekin the second booking with extra seat, the first one booked from QIK
So that

Scenario: Verify Oops message when checkin the second booking with cross reference and extra seat, the first one booked from QIK
