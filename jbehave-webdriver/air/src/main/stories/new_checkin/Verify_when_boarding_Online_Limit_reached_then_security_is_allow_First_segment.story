...
Scenario: Attempt a group checkin when Boading pass On line has reached the limit, so we should be capable of get security document
Given I am:
    |Field|Value|
...
And I have my reservation with all its passengers eligible to checkin online and boarding pass is not allow on Line at First Segment
