...
Verify that Southwest.com user sees flights that are in "Delayed" status on Check Flight Status Page
...
I want to recognize the flights that are in "Delayed" status
