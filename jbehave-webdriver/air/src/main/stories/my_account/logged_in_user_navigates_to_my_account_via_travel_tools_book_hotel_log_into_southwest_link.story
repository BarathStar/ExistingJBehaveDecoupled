A Southwest user (already logged in) navigates to the My Account page using the Travel Tools | Book Hotel | Log Into Southwest link
...
Scenario: An anonymous user (currently logged in) clicks on the Travel Tools | Book Hotel | Log Into Southwest link and is taken directly to the My Account page.
