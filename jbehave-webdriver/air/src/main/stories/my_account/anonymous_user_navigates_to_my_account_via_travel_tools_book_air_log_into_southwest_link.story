An anonymous user (not currently logged in) navigates to the My Account page using the Travel Tools | Book Air | Log Into Southwest link
...
Scenario: An anonymous user (not currently logged in) clicks on the Travel Tools | Book Air | Log Into Southwest link and is taken to the My Account Login page, where they must first log in. After successfully logging in, they are taken to the My Account page.
