An anonymous user (not currently logged in) navigates to the My Account page using the My Account | Login link in the page footer
...
Scenario: An anonymous user (not currently logged in) clicks on the My Account | Login link in the page footer and is taken to the My Account Login page, where they must first log in. After successfully logging in, they are taken to the My Account page.
