...
When I have multiple promotional certificates expiring soon, try to book a one-way promo cert pnr with departure date before the soonest cert expiry,
The cert with expiry date after departure date should be selected

Scenario: RR Member views promotions, and tries to book a one-way pnr with departure date before the soonest cert expiry date, sees correct cert on purchase page
...
Then I should see the rapid rewards awards displayed on the purchase page with certificates A1000011134000
