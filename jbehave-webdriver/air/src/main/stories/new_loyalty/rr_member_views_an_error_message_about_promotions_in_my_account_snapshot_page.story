...
I want to reach "Promotions" page (accessing through Account Snapshot section) when there is a CLCS Promotions service outage

Scenario: Rapid Rewards Member (with Promotions and no Promotional Certificates) views an error message in "Promotions" page (accessing from Account Snapshot section) when there is a CLCS Promotions service outage
...
And I access my account's Promotions from My Account Snapshot page
...
And I see a message indicating that Promotions can not be retrieved on My Account Snapshot page