Show an Oops message on Swabiz when the user attempts to change a flight using SJU itineraries with layover >= 4 hours
...
Scenario: Receive an Oops message when user tries to change flight using SJU itineraries with layover >=4 hours on SWABiz
