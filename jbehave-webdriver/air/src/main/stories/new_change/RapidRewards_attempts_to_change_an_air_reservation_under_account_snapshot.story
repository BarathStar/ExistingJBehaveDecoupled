Change the Air reservation accessing through "Change Reservation" link under "Upcoming Trips" section on "My Account Snapshot" page.
...
I want to see my Air product on "My Account Snapshot" page and attempt to change it accessing through "Change Reservation" link under "Upcoming Trips" section

Scenario: Rapid Rewards Member attempts to change an Air reservation accessing through "Change Reservation" link under "Upcoming Trips" section on "My Account Snapshot" page
...
And I attempt to change the Air product on My Account Snapshot page
