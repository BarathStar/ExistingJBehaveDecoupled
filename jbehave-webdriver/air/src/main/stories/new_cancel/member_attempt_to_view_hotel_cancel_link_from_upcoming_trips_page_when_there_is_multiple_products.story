View my Hotel Cancel Reservation Modal for trip with multiple associated products from the Upcoming Trips page
...
Narrative:
In order to view a Cancel Reservation Modal for trip with multiple product
As a Rapid Rewards Member (with Upcoming Trips)
I want to see the Cancel Reservation link for my Hotel product on Upcoming Trips page and cancel it being informed about other products in the trip

Scenario:
Rapid Rewards Member views my upcoming trips Hotel Cancel Reservation link from upcoming trips page
