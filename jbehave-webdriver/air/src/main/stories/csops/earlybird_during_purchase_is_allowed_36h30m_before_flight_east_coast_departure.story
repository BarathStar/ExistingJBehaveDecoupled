...
And Only the following one way schedule is available from PVD to GEG on +36h30m:
    |ond    |flight  |origin |departure   |destination|arrival|carrier|
    |1      |1001    |PVD    |+36h30m     |GEG        |+5h30m |WN     |

And The following routes are available:
    |Field|Value|
    |originStation|PVD|
    |destinationStation|GEG|
    |carrierDates|WN:T:[today+0,today+15]|

And I want to fly from from PVD to GEG on day of +36h30m
