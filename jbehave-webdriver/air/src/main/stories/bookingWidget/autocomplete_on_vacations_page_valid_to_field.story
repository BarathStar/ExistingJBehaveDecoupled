...
Scenario: Ensure vacation page shows dal station in to field

Given I am on the Vacations page
When I select DAL in the ToOnVacations field dropdown
Then I should see DAL in ToOnVacations field
