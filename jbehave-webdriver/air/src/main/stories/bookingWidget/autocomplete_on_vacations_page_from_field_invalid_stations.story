...
Scenario: Ensure No Airport Found is shown on autocomplete list when entering letters in from station that do not match

Given I am on the Vacations page
When I attempt to enter zzz in the FromOnVacations field
Then I should see the FromOnVacations field is empty
