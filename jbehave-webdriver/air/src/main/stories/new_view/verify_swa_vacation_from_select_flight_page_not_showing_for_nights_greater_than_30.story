Verify that SWA Vacations ad on Select Flight Page is not shown when the stay is greater than 30 nights when Southwest.com users select flights for a ezrez city.
...
Narrative:
As a Southwest.com user, when I select flights for an ezrez city and my length of stay is greater than 30 nights
