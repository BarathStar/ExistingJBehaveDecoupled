View alternate View Itinerary screen for QIK PNRs, which also will display a Hotel Dynamic Cross-Sell
...
Narrative: In order to verify the alternate View Itinerary screen for QIK, which also will display a Hotel Dynamic Cross-Sell
As a southwest.com user
I want to view an alternate screen when retrieving QIK PNRs
So that I have a cleaner "View Itinerary" screen discarding inappropriate information.

Scenario: View alternate View Itinerary screen for QIK PNRs, which also will display a Hotel Dynamic Cross-Sell
...
And I have a flight booked from QIK
