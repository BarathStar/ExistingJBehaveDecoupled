Verify coming soon oops message when user books an Outbound after FL[I] ends and before WN[I] begins and Inbound after WN[I] begins
...
As a Customer
I want to search for a WN/FL shared international city pair that Airtran has stopped serving and Southwest is yet to begin service for the requested outbound date
and Southwest is serving for the requested inbound date
