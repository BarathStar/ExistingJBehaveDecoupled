Verify coming soon oops message when user books an Outbound before FL[I] ends and IB after WN[I] begins when FL[I] service ends one day before WN[I] service begins
...
when Airtran service ends one day before Southwest service begins
...
And The following routes are available:
    ...
    |originStation|DAL|
    |destinationStation|MBJ|
    |carrierDates|WN:F:[today+31,today+90]|
And The following routes are available:
    |Field|Value|
    |originStation|MBJ|
    |destinationStation|DAL|
...
Then I see an Oops messages from search flight page indicating that Published scheduled service between (Dallas - DAL) and (Montego Bay - MBJ) does not begin until
