...
Narrative:
As an Adult
I want to book an AirTran only itinerary when seat selection toggle is off
So that I do not see seat fees verbiage in Select Flights to Upgrade page

Scenario: Verify seat fees verbiage is not shown in Select Flights to Upgrade page for an AirTran only itinerary when seat selection toggle is off
