...
Scenario: Oops Message on Home Page with airtan.com link if the route is AirTran redirect routes and if Southwest has schedules for this route
...
Then I see an Oops messages from home page indicating that please visit airtran.com to make this booking
